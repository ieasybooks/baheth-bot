...
from handlers import (button_handler, disable_bot_handler, enable_bot_handler, hadiths_classical_handler,
                      hadiths_semantic_handler, shamela_classical_handler, shamela_semantic_handler, start_handler,
                      tafrigh_handler, text_handler, transcriptions_handler)
