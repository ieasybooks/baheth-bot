...
from constants import ADMIN_USER_IDS, BACK_TO_LIST_MARKUP, COMMAND_MESSAGES, COMMANDS_MARKUP, SHOW_MORE_MARKUP
from processors import (hadiths_processor, shamela_classical_processor, shamela_semantic_processor, tafrigh_processor,
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
  ...
  if query.data == 'back_to_list':
    ...
    await commands_handler(update, context, show_more_button=True, show_more_results=True, user_id=query.from_user.id)
  else:
